...
public class Admin_List_AllStudent_Adapter extends RecyclerView.Adapter<Admin_List_AllStudent_Adapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            txtnameStu = itemView.findViewById(R.id.adt_tv_namestudent_listallstudent);
            txtcodeStu = itemView.findViewById(R.id.adt_tv_codestudent_listallstudent);
            thumbnailStu = itemView.findViewById(R.id.adt_img_student_listallstudent);
