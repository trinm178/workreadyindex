...
import com.example.wri.Activity.Admin.Teacher.Admin_Detail_Teacher;
...
public class Admin_List_AllTeacher_Adapter extends RecyclerView.Adapter<Admin_List_AllTeacher_Adapter.ViewHolder>{
    ...
    public Admin_List_AllTeacher_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.adapter_admin_item_teacher,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            txtnameTeacher = itemView.findViewById(R.id.adt_admin_listteacher);
            thumbnailTeacher = itemView.findViewById(R.id.adt_img_listteacher);
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(context, Admin_Detail_Teacher.class);
