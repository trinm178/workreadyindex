...
public class Admin_Add_Class extends AppCompatActivity {
    ...
    private EditText edt_name_addclass,edt_code_addclass,edt_maxstudent_addclass,edt_description_addclass;
    private String url = "http://192.168.1.113/wri/class/create_class.php";
    @Override
