...
public class Company_Detail_Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_back_company_detail_student = findViewById(R.id.id_back_company_detail_student);
        ...
        id_back_company_detail_student.setOnClickListener(new View.OnClickListener() {
            @Override
